...
export function RevenueChart({ data, bare }: { data: MonthlyData[]; bare?: boolean }) {
  const ct = useChartTheme();

  if (data.length === 0) {
    const empty = (
      <div className="flex items-center justify-center h-full min-h-40 text-gray-400 dark:text-gray-500 text-sm">
